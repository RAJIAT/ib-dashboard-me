...
| 7 | شاشة الإصلاحات اللحظية `/admin-setup` (للأدمن فقط) | ✅ |
| 8 | حذف بانر الديمو والمكونات القديمة | ✅ |

---

## 3. الخطوة الأخيرة من جانب الـ Owner (مرة واحدة)

سجّل دخول كأدمن ثم افتح:

```
/admin-setup
```

اضغط **"تشغيل الكل"**. هذا يقوم بـ:
