  ...
  ar: {
    ...
    upload: {
      ...
      cards: {
        ...
        vehiclePhotos: "صور المركبة (وجه وخلف)",
        vehicleVideo: "فيديو المركبة",
      },
      vehiclePhotosHint: "ارفع صورتين على الأقل: الواجهة الأمامية والخلفية للمركبة",
      optional: "اختياري",
      required: "إلزامي",
      addPhoto: "إضافة صورة",
      removePhoto: "إزالة",
  ...
  en: {
    ...
    upload: {
      ...
      cards: {
        ...
        vehiclePhotos: "Vehicle Photos (Front & Back)",
        vehicleVideo: "Vehicle Video",
      },
      vehiclePhotosHint: "Upload at least two photos: vehicle front and back",
      optional: "Optional",
      required: "Required",
      addPhoto: "Add photo",
      removePhoto: "Remove",
